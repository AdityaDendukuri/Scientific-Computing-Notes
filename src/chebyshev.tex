...
Just 20--30 terms often yield machine precision.
}
\label{thm:spectral-accuracy}

\addRemark{%
\textbf{Connection to Fourier Series:}\enspace
The Chebyshev polynomials are closely related to the Fourier series. Specifically, $T_n(x)$ corresponds to the real part of a Fourier series on the unit circle under the mapping $x = \cos \theta$. This connection explains their remarkable convergence properties for smooth functions.
}
