...
\begin{itemize}
    ...
    \item \textbf{Property:}\enspace $\bS$ is symmetric positive semidefinite (SPSD).
\end{itemize}
}
...
\addRemark{%
\textbf{(Interpretation)}\enspace Principal components are variance directions, not causal factors. A large loading identifies a direction of variation in the data matrix; it does not by itself explain why that variation occurs.
}
